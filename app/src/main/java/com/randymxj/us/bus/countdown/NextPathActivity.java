...
/**
 * Activity class for Route Map
 */
public class NextPathActivity extends AppCompatActivity implements
        OnMapReadyCallback {

    /* Final */
    private static final String TAG = "@@@ NextPathActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_path);

        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_next_path);
    ...
    /* Main getter */
    private NextPathActivity getMain() {
        return this;
    }
}
